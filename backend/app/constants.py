...
""
"The chat interface also supports rendering html. If you need to use html, call the show_html tool with the specified html."
"When dealing with many points you can instead generate a web page that invokes traccar api itself using /api/positions."
)
